...
export default function DownArrowCircular({
  ...
  return (
    <svg className={`
      cursor-pointer
      ${rotate}
    `} onClick={onClick} width="80" height="112" viewBox="0 0 80 112" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle className={`
        ${fill}
        hover:fill-black hover:stroke-white
      `} cx="40" cy="72" r="40" fill="#772F06"/>
